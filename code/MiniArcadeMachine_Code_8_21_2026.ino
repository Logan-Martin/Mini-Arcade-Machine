...
void setup() {
  ...
  PlayerTriangle.color = BLUE;
  tft.fillTriangle(PlayerTriangle.x0, PlayerTriangle.y0, PlayerTriangle.x1, PlayerTriangle.y1, PlayerTriangle.x2, PlayerTriangle.y2, PlayerTriangle.color);

  //PlayerCircle.color = BLUE;
...
void Render(float deltaTime) { // draw the graphics based on the Update changes
  ...
  //tft.fillCircle(PlayerCircle.xPos, PlayerCircle.yPos, PlayerCircle.radius , BACKGROUND_COLOR);
  tft.fillTriangle(PlayerTriangle.x0, PlayerTriangle.y0, PlayerTriangle.x1, PlayerTriangle.y1, PlayerTriangle.x2, PlayerTriangle.y2, BACKGROUND_COLOR)
